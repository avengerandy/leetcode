# Multi-digit multiplication without using multiplication;
# if necessary, even addition can be avoided by mapping a multiplication table
# (int can also be replaced by ord-based mapping with the same effect).
